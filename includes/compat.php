...
/**
 * Audition Compatibility Functions
 *
 ...
 */
function audition_retrieve_password() {
	$errors = new WP_Error();
 ...
 * @param string $key   The password reset key.
 */
function audition_retrieve_password_notification($user, $key) {
	if (is_multisite()) {
	 ...
	 */
	$retrieve_password_email = apply_filters('audition_retrieve_password_email', $retrieve_password_email, $user, $site_name);
