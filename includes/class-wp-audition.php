...
class WP_Audition {
	...
	public function __construct() {
		if ( defined( 'WP_AUDITION_VERSION' ) ) {
			$this->version = WP_AUDITION_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'wp-audition';
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-wp-audition-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-wp-audition-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-wp-audition-admin.php';
